...
const Services: React.FC = () => {
  ...
  const mainCards = [
    {
      ...
      description: "We help new startup teams build everything from scratch – name, branding, website, marketing, automation, and launch strategy.",
      benefits: [
    ...
    },
    {
      ...
      description: "Already running a business but not online? We guide you through full digital transformation to grow your business and reach more customers.",
      benefits: [
  ...
  const services = [
    { 
      ...
      description: "Crafting powerful brand identities with logos, color palettes, typography, and brand guidelines that resonate with your audience.",
    ...
    { 
      ...
      description: "Developing responsive websites and e-commerce platforms with full functionality, modern design, and seamless user experience.",
    ...
    { 
      ...
      description: "Smart automation and AI-powered tools to streamline your business processes and enhance customer experience.",
      icon: <Zap className="w-8 h-8" />,
      color: "yellow",
      features: ["Process Automation", "AI Integration", "Chatbots", "Smart Analytics"]
    },
    { 
      id: 4, 
      title: "Digital Marketing", 
      description: "Boosting your online presence through strategic campaigns, content marketing, and performance optimization across platforms.",
    ...
    { 
      ...
      description: "Professional video content creation for reels, promos, YouTube, and comprehensive brand storytelling.",
      icon: <Smartphone className="w-8 h-8" />,
      color: "pink",
      features: ["Video Production", "Animation", "Social Content", "Brand Videos"]
    },
    { 
      id: 6, 
      title: "Consulting & Strategy", 
      description: "Strategic consulting services for digital transformation, growth planning, and technology implementation.",
      icon: <Shield className="w-8 h-8" />,
      color: "teal",
      features: ["Strategy Planning", "Tech Consulting", "Growth Hacking", "Market Analysis"]
    }
  ];
  ...
  return (
    <section  className="py-20 lg:py-32 bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30 relative overflow-hidden" ref={ref}>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        {[...Array(8)].map((_, i) => (
          ...
          >
            <div className={`w-full h-full bg-gradient-to-br ${i % 2 === 0 ? 'from-purple-400 to-blue-400' : 'from-teal-400 to-green-400'} ${i % 3 === 0 ? 'rounded-full' : 'rounded-lg rotate-45'}`}></div>
          </motion.div>
        ))}
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-semibold text-purple-700">WHO WE HELP</span>
          </motion.div>
          ...
          >
            Whether you're starting from scratch or scaling your existing business, 
            we provide comprehensive digital solutions that grow with you.
          </motion.p>
        </motion.div>
        ...
        >
          {mainCards.map((card, index) => (
            ...
            >
              <div className={`relative h-full bg-gradient-to-br ${card.bgGradient} p-8 rounded-3xl border border-white/50 shadow-xl backdrop-blur-sm overflow-hidden transition-all duration-500 group-hover:shadow-2xl`}>
                {/* Background Pattern */}
          ...
          <div className="bg-gradient-to-r from-purple-600 via-blue-600 to-teal-600 rounded-3xl p-12 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
                Ready to transform your vision into reality? Get a free consultation and see how we can help your business grow.
              </p>
