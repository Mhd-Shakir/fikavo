...
import { Search, Palette, Rocket, Users, Target, TrendingUp, Sparkles, CheckCircle, PenTool, Code, DraftingCompass, Layers } from 'lucide-react';
...
const Process: React.FC = () => {
  ...
  const steps: StepData[] = [
    ...
    },
    {
      ...
      description: "We craft intuitive user experiences and beautiful interfaces that align with your brand identity.",
      details: [
    ...
    },
    {
      ...
      icon: Code,
      title: "Develop & Test",
      description: "Our developers build robust solutions while maintaining quality through rigorous testing.",
      details: [
    ...
    },
    {
      ...
      icon: Rocket,
      title: "Launch & Grow",
      description: "We ensure a smooth deployment and provide ongoing support to help your business scale.",
      details: [
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-white via-blue-50/30 to-purple-50/50 relative overflow-hidden" ref={ref}>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        {[...Array(30)].map((_, i) => (
          <motion.div
            ...
            style={{
              background: `rgba(${Math.random() * 100 + 150}, ${Math.random() * 100 + 150}, 255, 0.2)`,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-semibold text-purple-700 uppercase tracking-wider">OUR PROCESS</span>
          </motion.div>
          ...
          >
            Our proven methodology ensures your project's success from concept to launch and beyond.
          </motion.p>
        </motion.div>
            ...
            >
              <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                      ...
                      {steps.map((_, dotIndex) => (
                        <motion.div
                          ...
                          className={`w-2 h-2 rounded-full ${
                            dotIndex <= index ? `bg-${step.color}-600` : 'bg-gray-300'
                          }`}
                          animate={{
                            scale: hoveredStep === index && dotIndex === index ? [1, 1.5, 1] : 1
                          }}
                          transition={{ duration: 0.5, repeat: hoveredStep === index && dotIndex === index ? Infinity : 0 }}
                        />
                      ))}
                    </div>
                  </div>
                ...
                >
                  ...
                  {/* Expand Button */}
                  <motion.button
                    className={`mt-6 px-6 py-3 bg-gradient-to-r from-${step.color}-100 to-${step.color === 'purple' ? 'blue' : step.color === 'blue' ? 'cyan' : step.color === 'teal' ? 'emerald' : 'lime'}-100 hover:from-${step.color}-200 hover:to-${step.color === 'purple' ? 'blue' : step.color === 'blue' ? 'cyan' : step.color === 'teal' ? 'emerald' : 'lime'}-200 text-${step.color}-700 font-semibold rounded-xl transition-all duration-300`}
                    onClick={() => setActiveStep(activeStep === index ? null : index)}
  ...
  >
    ...
    <span className="text-xs sm:text-sm font-semibold">READY TO START?</span>
  </motion.div>
