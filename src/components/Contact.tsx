            ...
            {submissionStatus === "success" ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-md bg-white text-black border border-gray-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-300 outline-none"
                />
                <input
                  type="email"
                  name="email"
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-md bg-white text-black border border-gray-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-300 outline-none h-28 sm:h-32 resize-none"
                />
                <button
                  type="submit"
