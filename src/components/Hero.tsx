              ...
              <div className="relative">
                ...
                >
                  <img
                    ...
                    className="w-full h-[400px] md:h-[600px] md:object-fit stransition-transform duration-700 group-hover:scale-105"
                  />
                  ...
                  <motion.div className="absolute inset-0 bg-gradient-to-br from-purple-600/0 to-blue-600/0 opacity-0 group-hover:from-purple-600/10 group-hover:to-blue-600/10 group-hover:opacity-100 transition-all duration-500" />
                </motion.div>
